export declare enum UserRoleFilter {
    BUYER = "BUYER",
    SELLER = "SELLER"
}
export declare enum InquirySearchFieldGroup {
    DEFAULT = "DEFAULT",
    SUMMARY = "SUMMARY"
}
export declare enum CaseStatusFilter {
    CLOSED = "CLOSED",
    CS_CLOSED = "CS_CLOSED",
    ON_HOLD = "ON_HOLD",
    OPEN = "OPEN",
...
export declare enum CaseSearchFieldGroup {
    DEFAULT = "DEFAULT",
    SUMMARY = "SUMMARY"
}
export declare enum InquiryStatusFilter {
    CLOSED = "CLOSED",
...
export declare enum GetReturnFieldGroupEnum {
    FULL = "FULL",
    NONE = "NONE",
    SUMMARY = "SUMMARY"
}
export declare enum EscalateReason {
...
export declare enum ReturnCountFilter {
    ALL_OPEN = "ALL_OPEN",
...
export declare enum RefundFeeType {
...
export declare enum ActivityOption {
...
export declare enum TimeDurationUnit {
    YEAR = "YEAR",
    MONTH = "MONTH",
    DAY = "DAY",
    HOUR = "HOUR",
...
export declare enum ShippingOptionType {
    DOMESTIC = "DOMESTIC",
    INTERNATIONAL = "INTERNATIONAL"
}
export declare enum ShippingCostType {
    CALCULATED = "CALCULATED",
    FLAT_RATE = "FLAT_RATE",
    NOT_SPECIFIED = "NOT_SPECIFIED"
}
export declare enum PaymentsProgramType {
    EBAY_PAYMENTS = "EBAY_PAYMENTS"
}
export declare enum PaymentsProgramStatus {
    OPTED_IN = "OPTED_IN",
...
export declare enum RecipientAccountReferenceType {
...
export declare enum ReturnShippingCostPayer {
    BUYER = "BUYER",
    SELLER = "SELLER"
}
...
export declare enum ReasonForRefund {
...
export declare enum LengthUnitOfMeasure {
    INCH = "INCH",
    FEET = "FEET",
    CENTIMETER = "CENTIMETER",
    METER = "METER"
}
export declare enum WeightUnitOfMeasure {
    POUND = "POUND",
    KILOGRAM = "KILOGRAM",
    OUNCE = "OUNCE",
    GRAM = "GRAM"
